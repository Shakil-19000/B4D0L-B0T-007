...
module.exports.config = {
    ...
    version: "1.0.0",
    hasPermision: 0,
    credits: `Deku & Yan Maglinte and canvas editor by BADOL-KHAN`, //Added Canvas Design by Yan and Editor Canvas Design By BADOL-KHAN 
    usePrefix: false,
    description: "get badde using tag/mention/reply to a message",
    usages: "[reply/tu/@mention/tag]",
    commandCategory: "info",
    cooldowns: 0,
};

const background = "https://i.imgur.com/03hl7PU.jpg";
    ...
    try {
        ...
        let callback = async function() {
            ...
            return api.sendMessage({
                body: `ꔸꗥ⃟ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿(HAPPY-BIRTHDAY)ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿⃟ꗥꔸ\n\n❂⃝⃘ »̶̶͓͓͓̽̽̽ (${name} )»̶̶͓͓͓̽̽̽⑅⃝✺\n\n ___ღ______________________'༉࿐\n\nশুভ হোক এই দিন আজ তোমার জন্মদিন\n\n╔━━✿✿🦋🎂🥧🍨🌺✿✿━━╗\n\n${name}\n\n╚━━✿✿🌺🍨🥧🎂🦋✿✿━━╝\n\n___ღ______________________'༉࿐\n\n╔━━✿✿🦋🍨🥧🎂🌺✿✿━━╗\n\n ◆~শুভজন্মদিন~◆ \n\n ╚━━✿✿🌺🍨🥧🎂🦋✿✿━━╝\n\n ___ღ______________________'༉࿐\n\n আশা রাখি জীবনের আনন্দ যাত্রায়\n কখনোই সত্যির পথ থেকে সরে যাবে না\n তোমার সাথে অনেক মজা করছি রাগ করিওনা\n সরি 🤦‍♂️ দেরিতে WISH করলাম\n জন্মদিনের শুভেচ্ছা নিও।:\n ꔸꗥ⃟ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿◆Happy-Birthday◆ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿⃟ꗥꔸ\n\n\n ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿⃟ꗥꔸ𝗠𝗖𝗦-𝗕𝗔𝗗𝗢𝗟-𝗕𝗢𝗧-𝟬𝟬𝟳ꔸꗥ⃟ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿`,
