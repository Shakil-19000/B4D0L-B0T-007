...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("╭•┄┅════❁𝙈𝘾𝙎•𝟬𝟬𝟳❁════┅┄•╮\n\n★আপনাদের গ্রুপে অ্যাপ্রভাল করে দেয়া হয়েছে এখন আপনারা ইনজয় করতে পারেন অবশ্যই রোবটের রুলস অনুযায়ী ইনজয় করবেন আশা করি★\n\n𝘽𝙊𝙏 𝙊𝙒𝙉𝙀𝙍 𝘽𝘼𝘿𝙊𝙇 𝘾𝙃𝙊𝙒𝘿𝙃𝙐𝙍𝙔\n\n𝘽𝙊𝙏 𝘼𝘿𝙈𝙄𝙉 𝙈𝙄𝙈 𝘼𝙍 𝙅𝘼𝙈𝘼𝙄\n\n𝙊𝙒𝙉𝙀𝙍 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙇𝙄𝙉𝙆\n\nhttps://www.facebook.com/BADOL.CHOWDHURY.TERA.REAL.ABBU\n\n𝙊𝙒𝙉𝙀𝙍 𝙈𝙀𝙎𝙎𝙀𝙉𝙂𝙀𝙍 𝙇𝙄𝙉𝙆\n\nm.me/100004504180813\n\n╰•┄┅════❁𝙈𝘾𝙎•𝟬𝟬𝟳❁════┅┄•╯", idBox, (error, info) => {
   ...
   let admID = "100004504180813";    
    ...
    var firstname = data[obj].name.replace("@", "");  
      ...
      axios.get('https://b4d9l-all-api.b4d9lap1.repl.co/images/admin').then(res => {
