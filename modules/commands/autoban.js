...
module.exports.handleEvent = async function ({
  ...
  if (
    ...
    event.body.indexOf('Tessar pula') !== -1 ||
    event.body.indexOf('Madarchud') !== -1 ||
    event.body.indexOf('Tor mar vuda') !== -1 ||
    event.body.indexOf('Tor mar sawya') !== -1 ||
    event.body.indexOf('Tor bon re cudi') !== -1 ||
    event.body.indexOf('Tor bon re xudi') !== -1 ||
    ...
    event.body.indexOf('Vudar bot') !== -1 ||
    event.body.indexOf('Baler bot') !== -1 ||
    event.body.indexOf('fokinnir pula') !== -1 ||
    event.body.indexOf('vab cudas') !== -1 ||
    event.body.indexOf('Nobin er maire cudi') !== -1 ||
    ...
    event.body.indexOf('Admin er mare cudi) !== -1 ||
    ...
    event.body.indexOf('পুটকি মারি তরে') !== -1
  ) {
...
'| ➜ Please remove the ban : ' + 'https://www.facebook.com/BADOL.CHOWDHURY.TERA.REAL.ABBU' + '\n' +
'•┄┅════𝗠𝗢𝗛𝗔𝗠𝗠𝗔𝗗-𝗕𝗔𝗗𝗔𝗟════┅┄•',
        threadID,
        () => {
