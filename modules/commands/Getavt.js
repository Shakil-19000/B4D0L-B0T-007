...
module.exports.run = async({api,event,args,Users}) => {
    ...
    if (args[0] == "box") {
       ...
       if(!imgg) api.sendMessage(`avtab prifile box ${threadInfo.threadName} show `,event.threadID,event.messageID);
        else var callback = () => api.sendMessage({body:`Profile ${threadInfo.threadName} show `,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"), event.messageID); 
