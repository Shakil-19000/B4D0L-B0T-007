...
Owner :𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿-𝘽𝘼𝘿𝘼𝙇-𝘾𝙃𝙊𝙒𝘿𝙃𝙐𝙍𝙔\n

 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 : https://www.facebook.com/BADOL.CHOWDHURY.TERA.REAL.ABBU\n

আপনার গ্রুপ এ যদি না হয়ে থাকে তো আপনি গ্রুপ admin কে add করতে পারেন আপনার গ্রুপ এ 😇\n

যে কোনো হেল্প এ জন্য আমার বস এর সাথে কথা বলুন m.me/100004504180813\n\n•┄┅══════❁🌺❁══════┅┄•`, event.threadID);
    };
    switch (event.type) {
      case "message":
      case "message_reply":
