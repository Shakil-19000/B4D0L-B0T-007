...
exec("rm -rf modules/commands/data && mkdir -p modules/commands/data && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("BADOL KHAN (MCS) ❯ ") + chalk.hex("#00ffff")("fixed by BADOL KHAN (MCS)"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ BADOL KHAN (MCS) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`BADOL KHAN`, '[ BADOL KHAN (MCS) ]');
        logger('Hey, thank you for using this Bot', '[ BADOL KHAN (MCS) ]');
        logger("Fixed by BADOL KHAN", '[ BADOL KHAN (MCS) ]');
